...
Route::group('api/:version/',function(){
    // 新增配置
    Route::any('test/insertconfig','api/:version.Test/insertConfig');
    // 临时测试
    Route::any('test','api/:version.Test/temp');
    Route::any('test/json','api/:version.Test/json')->allowCrossDomain();
    // 判断当前用户第三方登录绑定情况
